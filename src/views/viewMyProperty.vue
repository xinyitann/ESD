<template>
    ...
    <!--start of cards-->
        <div class="container d-xl-flex justify-content-center py-4 py-xl-5">
            <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3 text-start justify-content-center">
                    <div class="col">
                        <div class="card">
